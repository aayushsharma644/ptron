...
class SupportController extends Controller
{
    ...
    public function reply(Request $request, $id)
    {
        ...
        if ($request->replayTicket == 1) {
            ...
            $this->userFirebasePushNotification($user, 'USER_NOTIFY_OWN_TICKET_REPLY', $msg, route('user.ticket.view', $ticket->ticket));
            ...
            $this->userFirebasePushNotification($user, 'USER_NOTIFY_OWN_TICKET_CLOSE', $msg, route('user.ticket.view', $ticket->ticket));

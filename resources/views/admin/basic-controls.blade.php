            ...
            <form method="post" action="" class="needs-validation base-form">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        <label class="">@lang('Site Title')</label>
                    ...
                    @if(config('basic.theme') != 'deepblack')
                        <div class="form-group col-md-3">
                            <label class="">@lang('Base Color')</label>
                        ...
                        @if(in_array(config('basic.theme'),['lightpink','lightyellow']))
                            ...
                            <div class="form-group col-md-3">
                                <label class="">@lang('Base Light Color')</label>
                            ...
                            <div class="form-group col-md-3">
                                <label class="">@lang('Secondary Color')</label>
                            ...
                            <div class="form-group col-md-3">
                                <label class="">@lang('Heading Color')</label>
                    ...
                    <div class="form-group col-md-3">
                        <label class="">@lang('APP TIMEZONE')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="">@lang('Base Currency')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="">@lang('Currency Symbol')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="">@lang('Fraction number')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="">@lang('Paginate Per Page')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="">@lang('Minimum Transfer')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="">@lang('Maximum Transfer')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="">@lang('Transfer Charge')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="">@lang('Bonus Amount')</label>
                        <div class="input-group mb-3">
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-3 ">
                        <label class="">@lang('Joining bonus')</label>
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class="">@lang('Strong Password')</label>
                        <div class="custom-switch-btn">
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class="">@lang('Registration')</label>
                        <div class="custom-switch-btn">
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class="">@lang('Debug Mode')</label>
                        <div class="custom-switch-btn">
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class="">@lang('Top Investor')</label>
                        <div class="custom-switch-btn">
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class="">@lang('Deposit & Withdrawals')</label>
                        <div class="custom-switch-btn">

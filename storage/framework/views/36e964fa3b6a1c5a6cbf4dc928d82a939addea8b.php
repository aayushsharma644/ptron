...
unset($__errorArgs, $__bag); ?>
                                ...
                                <h4 class="text-center mb-2"><?php echo app('translator')->get($user->fullname); ?> <sup><sapn class="badge badge-pill bg-outline-success badge_lavel_style text-white border-1"><?php echo e(@$user->rank->rank_lavel); ?></sapn></sup></h4>
                                <h5 class="text-center mt-2 mb-3"><?php echo app('translator')->get(@$user->rank->rank_name); ?></h5>
                                <p class="text-center mb-2"><?php echo app('translator')->get('Joined At'); ?> <?php echo app('translator')->get($user->created_at->format('d M, Y g:i A')); ?></p>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u498872279/domains/ptrontrade.in/public_html/resources/views/themes/lightorange/user/profile/myprofile.blade.php ENDPATH**/ ?>
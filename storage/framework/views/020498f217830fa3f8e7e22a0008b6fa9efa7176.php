    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                                    ...
                                    <span class="hide-menu"><?php echo app('translator')->get('Firebase Push Notification'); ?></span>
                                </a>
                                <ul aria-expanded="false" class="collapse first-level base-level-line">
                                    <li class="sidebar-item">
                ...
                <?php endif; ?>
                <li class="list-divider"></li>
                <li class="nav-small-cap"><span class="hide-menu text-dark">Version 6.0</span></li>
...
<?php /**PATH /home/u498872279/domains/ptrontrade.in/public_html/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>
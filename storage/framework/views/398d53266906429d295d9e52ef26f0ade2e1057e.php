            ...
            <div class="tab-content">
                <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane <?php echo e(($key == 0) ? 'show active' : ''); ?>" id="tab-<?php echo e($value->id); ?>">
                        ...
                        <form action="<?php echo e(route('admin.push.notify-template.update',$value->id)); ?>" method="POST"
                              class="mt-4">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\XAMPP\htdocs\ptron\resources\views/admin/pushNotify/edit.blade.php ENDPATH**/ ?>
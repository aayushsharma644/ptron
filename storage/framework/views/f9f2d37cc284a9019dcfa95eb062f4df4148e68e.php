                                ...
                                <form class="form-row" action="" method="post">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <label><?php echo app('translator')->get('Receiver Username'); ?></label>
                                            <input class="form-control" type="username" name="username" value="<?php echo e(old('username')); ?>" placeholder="<?php echo app('translator')->get('Receiver Username'); ?>">
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMPP\htdocs\ptron\resources\views/themes/lightorange/user/money-transfer.blade.php ENDPATH**/ ?>
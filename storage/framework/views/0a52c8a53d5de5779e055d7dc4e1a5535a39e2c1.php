            ...
            <form method="post" action="" class="needs-validation base-form">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        <label class=""><?php echo app('translator')->get('Site Title'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(config('basic.theme') != 'deepblack'): ?>
                        <div class="form-group col-md-3">
                            <label class=""><?php echo app('translator')->get('Base Color'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(in_array(config('basic.theme'),['lightpink','lightyellow'])): ?>
                            ...
                            <div class="form-group col-md-3">
                                <label class=""><?php echo app('translator')->get('Base Light Color'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-3">
                                <label class=""><?php echo app('translator')->get('Secondary Color'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-3">
                                <label class=""><?php echo app('translator')->get('Heading Color'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-md-3">
                        <label class=""><?php echo app('translator')->get('APP TIMEZONE'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class=""><?php echo app('translator')->get('Base Currency'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class=""><?php echo app('translator')->get('Currency Symbol'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class=""><?php echo app('translator')->get('Fraction number'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class=""><?php echo app('translator')->get('Paginate Per Page'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class=""><?php echo app('translator')->get('Minimum Transfer'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class=""><?php echo app('translator')->get('Maximum Transfer'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class=""><?php echo app('translator')->get('Transfer Charge'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class=""><?php echo app('translator')->get('Bonus Amount'); ?></label>
                        <div class="input-group mb-3">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-3 ">
                        <label class=""><?php echo app('translator')->get('Joining bonus'); ?></label>
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class=""><?php echo app('translator')->get('Strong Password'); ?></label>
                        <div class="custom-switch-btn">
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class=""><?php echo app('translator')->get('Registration'); ?></label>
                        <div class="custom-switch-btn">
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class=""><?php echo app('translator')->get('Debug Mode'); ?></label>
                        <div class="custom-switch-btn">
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class=""><?php echo app('translator')->get('Top Investor'); ?></label>
                        <div class="custom-switch-btn">
                            <input type='hidden' value='1' name='top_investor'>
                            <input type="checkbox" name="top_investor" class="custom-switch-checkbox"
                                   id="top_investor"
                                   value="0" <?php if ($control->top_investor == 0):echo 'checked'; endif ?> >
                            <label class="custom-switch-checkbox-label" for="top_investor">
                                <span class="custom-switch-checkbox-inner"></span>
                                <span class="custom-switch-checkbox-switch"></span>
                            </label>
                        </div>
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-4">
                        <label class=""><?php echo app('translator')->get('Deposit & Withdrawals'); ?></label>
                        <div class="custom-switch-btn">
                            <input type='hidden' value='1' name='deposit_withdrawals'>
                            <input type="checkbox" name="deposit_withdrawals" class="custom-switch-checkbox"
                                   id="deposit_withdrawals"
                                   value="0" <?php if ($control->deposit_withdrawals == 0):echo 'checked'; endif ?> >
                            <label class="custom-switch-checkbox-label" for="deposit_withdrawals">
                                <span class="custom-switch-checkbox-inner"></span>
                                <span class="custom-switch-checkbox-switch"></span>
                            </label>
                        </div>
                ...
                <button type="submit" class="btn waves-effect waves-light btn-rounded btn-primary btn-block mt-3"><span><i class="fas fa-save pr-2"></i> <?php echo app('translator')->get('Save Changes'); ?></span></button>
            </form>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u498872279/domains/ptrontrade.in/public_html/resources/views/admin/basic-controls.blade.php ENDPATH**/ ?>